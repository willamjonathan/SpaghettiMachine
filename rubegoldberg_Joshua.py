...
# Create the track
track_length = 230  # Adjusted track length
track_thickness = 1
track_height = 1
track = box(
    pos=vector(0, 0, 0),
...
obstacle2 = box(pos=vector(0, 30, 0), length=10, width=2, height=6, color=color.green)
obstacle3 = box(pos=vector(30, 20, 0), length=10, width=2, height=6, color=color.orange)
obstacle4 = box(
    pos=vector(60, 30, 0), length=10, width=2, height=6, color=color.magenta
)
obstacle5 = box(pos=vector(80, 20, 0), length=10, width=2, height=6, color=color.yellow)
obstacle6 = box(pos=vector(100, 30, 0), length=10, width=2, height=6, color=color.cyan)
